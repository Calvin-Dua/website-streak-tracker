      ...
      <div style={{ position: 'relative', zIndex: 10 }}>
        ...
        <nav style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
            ...
            <span style={{ fontSize: 13, color: '#7a4a2e', cursor: 'pointer' }}>Pricing</span>
        ...
        <section style={{ textAlign: 'center', padding: '64px 32px 48px' }}>
          ...
          <h1 style={{
            fontSize: 42, fontWeight: 500, color: '#3d1f0a',
            lineHeight: 1.2, maxWidth: 520, margin: '0 auto 18px',
          }}>
          ...
          <p style={{
            ...
            maxWidth: 400, margin: '0 auto 32px', lineHeight: 1.8,
          }}>
          ...
          <div style={{
            ...
            justifyContent: 'center', maxWidth: 460, margin: '0 auto',
          }}>
        ...
        {/* Features */}
        <section style={{ padding: '48px 40px', borderTop: '1px solid #ffffff33' }}>
          <p style={{
          ...
          <div style={{
            ...
            gap: 16, maxWidth: 660, margin: '0 auto',
          }}>
            {[
              ...
              <div key={f.title} style={{
                ...
                <p style={{ fontSize: 14, fontWeight: 500, color: '#3d1f0a', marginBottom: 6 }}>{f.title}</p>
                <p style={{ fontSize: 12, color: '#7a4a2e', lineHeight: 1.7 }}>{f.desc}</p>
              </div>
            ))}
          </div>
        </section>
          ...
          <div style={{
            ...
            {[
              ...
              <div key={s.step} style={{ textAlign: 'center', padding: '16px 12px' }}>
                ...
                <p style={{ fontSize: 13, fontWeight: 500, color: '#3d1f0a', marginBottom: 6 }}>{s.title}</p>
                <p style={{ fontSize: 12, color: '#7a4a2e', lineHeight: 1.7 }}>{s.desc}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section style={{ padding: '48px 40px', borderTop: '1px solid #ffffff33' }}>
          ...
          <div style={{
            display: 'grid', gridTemplateColumns: 'repeat(3,1fr)',
            gap: 14, maxWidth: 620, margin: '0 auto 48px',
          }}>
            {[
              ...
              <div key={t.handle} style={{
                ...
                <p style={{ fontSize: 12, color: '#3d1f0a', lineHeight: 1.7 }}>&ldquo;{t.quote}&rdquo;</p>
              </div>
            ))}
          </div>
          ...
          <div style={{
            ...
            <h2 style={{ fontSize: 24, fontWeight: 500, color: '#3d1f0a', marginBottom: 10 }}>
              Ready to build your streak?
            </h2>
            <p style={{ fontSize: 13, color: '#7a4a2e', marginBottom: 24, lineHeight: 1.7 }}>
            ...
            <p style={{ fontSize: 11, color: '#7a4a2e88', marginTop: 14 }}>
